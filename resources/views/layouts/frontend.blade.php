...
<head>
    ...
    <link rel='stylesheet' id='rs-plugin-settings-css' href="{{ asset('/frontassets/js/vendor/plugins/revslider/public/assets/css/settings.css')}}"  type='text/css'/>
    <link rel='stylesheet' id='essential-grid-plugin-settings-css' href="{{ asset('/frontassets/js/vendor/plugins/essential-grid/public/assets/css/settings.css')}}" type='text/css' />
     <link rel='stylesheet'  href="{{ asset('/frontassets/css/fontello/fontello.css')}}" type='text/css' />
    <link rel='stylesheet'  href="{{ asset('/frontassets/css/style.css')}}" type='text/css' />
    <link rel='stylesheet'  href="{{ asset('/frontassets/css/global.css')}}" type='text/css' />
    <link rel='stylesheet'  href="{{ asset('/frontassets/js/vendor/fw/css/core.animation.css')}}" type='text/css' />
    <link rel='stylesheet' id='charity_is_hope-shortcodes-style-css' href="{{ asset('/frontassets/js/vendor/shortcodes/theme.shortcodes.css')}}" type='text/css' />
...
<body class="home page page-template-default body_style_wide top_style_header_1 body_filled article_style_stretch layout_single-standard template_single-standard scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide">
    <a id="toc_home" class="sc_anchor" title="Home" data-description="&lt;i&gt;Return to Home&lt;/i&gt; - &lt;br&gt;navigate to home page of the site" data-icon="icon-home" data-url="http://barakaministries.org/" data-separator="yes"></a>
